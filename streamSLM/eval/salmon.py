...
def main():
    ...
    ap.add_argument("--data_root", default=os.environ.get("SALMON_DATA_ROOT"),
                    required="SALMON_DATA_ROOT" not in os.environ,
                    help="SALMon dataset root (env: SALMON_DATA_ROOT).")
